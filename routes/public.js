...
const { accountBillingValidation, accountProfileValidation, authenticatedPasswordChangeValidation } = require('../middleware/validate');
...
router.put('/api/auth/account/profile', requireUser, accountProfileValidation, accountController.updateProfile);
router.put('/api/auth/account/billing', requireUser, accountBillingValidation, accountController.updateBilling);
router.post('/api/auth/account/password', requireUser, authenticatedPasswordChangeValidation, accountController.changePassword);
...
router.post('/api/academy/lessons/:id/progress', requireUserApi, academyController.updateLessonProgress);
